...
CSS_LINE_CEILING=14639 # Buddy page one view: hero + mobile-buddy.css folded into BuddyDetail.css (-65), 2026-09-26; earlier: 14704 channel CSS on tokens + primitives (-95), 2026-09-26; earlier: 14799 channel parity merged (DM notice +10, paid by Chat.css/Sidebar.css merges); channel parity merged (DM notice +10, paid by Chat.css/Sidebar.css merges), 2026-09-26; earlier: 14801 dead-code sweep, 14836 banner, 14831 PORT-3, 14838 audit, 14841 S6+port, 14855 S6, 14947, 14961, 14975, 14980; 15834 on 4e5a01c
