> Historical design, archived 2026-09-08. The living contract is `product/buddies/PLANNING_MEMORY.md`.
...
- `agent_notes/2026-08-22_memory-design-review.md` — source-backed review and the
...
- The review found the npm archive packages ignored runtime memory. Evidence:
  `agent_notes/2026-08-22_memory-design-review.md` §3. This is a release gate.
