...
// The 2026-08-20 report was "drag and drop stopped working": the exhausted
// drain only console.error'd. The rejection (with its reason, which the shells
// render as `uploadError`) is what makes a failed drop visible.
