 ...
 * Hand it to `renderMarkdown` (utils/markdown-pipeline) — never render chat
 * or channel text through react-markdown's `<Markdown>`, which rebuilds and
 * re-freezes the whole processor on every render.
 */
