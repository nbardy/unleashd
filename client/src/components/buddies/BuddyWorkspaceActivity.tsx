import { BuddyWorkspaceActivitySchema, type BuddyWorkspaceActiveJob } from '@unleashd/shared';
  ...
  const loadActivity = useCallback(
    async (signal: AbortSignal) => {
      ...
      const response = await fetch(
        `/api/buddies/workspaces/${encodeURIComponent(workspaceId)}/activity`,
        { signal }
      );
      if (!response.ok) {
