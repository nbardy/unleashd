...
import { BuddySoulEditor } from './BuddySoulEditor';
import { formatMemoryWriteError, memoryDocument } from './memory';
...
export function BuddyMemoryPanel({
  ...
  return (
    ...
    >
      ...
      {!scoped && <BuddySoulEditor key={buddy.id} buddyId={buddy.id} className={className} />}
